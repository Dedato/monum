...
<form action="<?php echo esc_url( $product->add_to_cart_url() ); ?>" 
	...
	<?php if ( !empty( $available_variations ) ) : ?>
		...
		<div class="variation_form_section">
			...
			?>      
			<div class="clear"></div><a id="variations_clear" href="#reset" style="display:none;"><?php _e( 'Reset selection', 'monum' ); ?></a>
		...
		<div class="single_variation_wrap" style="display:none;">
			...
			<div class="variations_button">
				...
				<button type="submit" class="single_add_to_cart_button button alt"><?php echo apply_filters( 'single_add_to_cart_text', __( 'Order', 'monum' ), $product->product_type ); ?></button>
			</div>
		</div>
		<div>
